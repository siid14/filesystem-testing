 ...
 *               within the basic file system. It includes functionalities
 *               for initializing directories, managing directory entries,
 *               path manipulation, checking directory emptiness,
